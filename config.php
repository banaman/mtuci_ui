...
// The $THEME is defined before this page is included and we can define settings by adding properties to this global object.
...
$THEME->scss = function($theme) {
    return theme_mtuci_ui_get_main_scss_content($theme);
};

$THEME->prescsscallback = 'theme_mtuci_ui_get_pre_scss';
$THEME->extrascsscallback = 'theme_mtuci_ui_get_extra_scss';
