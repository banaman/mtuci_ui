 ...
 * @return string sccs
 */
function theme_mtuci_ui_get_main_scss_content($theme) {
    global $CFG;
    ...
    if ($filename == 'default.scss') {
        $scss .= file_get_contents($CFG->dirroot . '/theme/mtuci_ui/scss/preset/default.scss');
    ...
    $pre = file_get_contents($CFG->dirroot . '/theme/mtuci_ui/scss/pre.scss');
    // Post CSS - this is loaded AFTER the main scss but before the extra scss from the setting.
    $post = file_get_contents($CFG->dirroot . '/theme/mtuci_ui/scss/post.scss');
 ...
 * @return void
 */
function theme_mtuci_ui_update_settings_images($settingname) {
    global $CFG;

    // The setting name that was updated comes as a string like 's_theme_mtuci_ui_loginbackgroundimage'.
    ...
    $pathname = $CFG->dataroot . '/pix_plugins/theme/mtuci_ui/' . $settingname . '.' . $extension;

    // This pattern matches any previous files with maybe different file extensions.
    $pathpattern = $CFG->dataroot . '/pix_plugins/theme/mtuci_ui/' . $settingname . '.*';

    // Make sure this dir exists.
    @mkdir($CFG->dataroot . '/pix_plugins/theme/mtuci_ui/', $CFG->directorypermissions, true);
 ...
 * @return string scss
 */
function theme_mtuci_ui_get_pre_scss($theme) {
    global $CFG;
 ...
 * @return string scss
 */
function theme_mtuci_ui_get_extra_scss($theme) {
